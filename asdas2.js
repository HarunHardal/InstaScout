// searchBusinessAccounts fonksiyonunun başlangıcı
            ...
            for (const postUrl of postLinks) {
                ...
                try {
                    ...
                    const username = await newPage.evaluate(() => {
                        ...
                        // href'i "/kullaniciadi/" formatında olan ve alakasız linkleri dışlayan seçici.
                        ...
                        // 2. Alternatif: Gönderi başlığındaki belirli span veya div yapıları
                        // Bu seçici, verdiğiniz HTML yapısına özel olarak oluşturulmuştur.
                        // class isimleri sürekli değişebilir, Instagram'dan anlık olarak kontrol etmek en iyisi.
                    ...
                    // İşletme hesabı olup olmadığını, takipçi sayısını ve biyografiyi çekme - GÜNCEL VE SAĞLAM SEÇİCİLER
                    const accountInfo = await newPage.evaluate(() => {
                        // İşletme göstergelerini kontrol edin (genişletilmiş seçiciler)
                        const isBusinessAccount = !!(
                            document.querySelector('[aria-label*="Contact"]') || // "İletişim" butonu
                            document.querySelector('a[href*="mailto:"]') ||     // E-posta linki
                            document.querySelector('a[href*="tel:"]') ||        // Telefon linki
                            document.querySelector('[data-testid="business_category"]') || // İşletme kategori etiketi
                            document.querySelector('div[class*="business"]') || // 'business' kelimesini içeren div (genel bir sınıf)
                        ...
                        let followers = 0;
                        // Hem 'title' özelliği olan, hem de sadece metin içeren takipçi sayılarını hedefle.
                        ...
                        for (const element of followerElements) {
                            ...
                            if (text) {
                                // Virgülleri kaldır, K/M/B gibi kısaltmaları çözümle
...
// searchBusinessAccounts fonksiyonunun sonu